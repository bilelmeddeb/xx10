...
public class Z1SondageApplication {
	...
	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(Z1SondageApplication.class, args);
		 ...
		 /***************************************************creation des user************************************************************/
		 User bilel= userRepository.save(new User("098-bilel", "bilel", "meddeb", "bilel@meddeb.com", (long) 23206993, "123456789", new Date()));
		 User hamza= userRepository.save(new User("097-hamza", "hamza", "hamzaa", "hamza@hamzaa.com", (long) 23206993, "123456789", new Date()));
		 User ADMIN= userRepository.save(new User("096-admin", "admin", "adminn", "admin@adminn.com", (long) 23206993, "123456789", new Date()));
		...
		/*  
		  ...
		  Sondage_I_Respond.add(Sondage_s1);
		  Sondage_I_Respond.add(Sondage_s2);
		  ...
		  Sondage_s2.setUsers_jawbou_3aliya(users);
		  ...
		  Sondage_I_Respond2.add(Sondage_s1);
		  ...
		  sondageRepository.save(Sondage_s1);  
		  /*
		   * a3malit affectation l reponce l qusetion 
		   * kif namil affichage nilka kima jawib hamza kima jawib bilel
		   * aslan il affectation ala chkoun sarit ala bilel wala ala hamza 
		   * khater bilel jawib ala sondage 1 w 2 
		   * w hamza jawib kan ala sondage 1
		   * 
		  ...
		  List<Optiona> Choices = userRepository.Get_Liste_Reponce(bilel.getCin(), Sondage_s1.getId());
		  System.out.println("*********************");
